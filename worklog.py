...
class Worklog:
    ...
    def lookup_menu(self):
        ...
        if len(self.task_list.tasks) == 0:
            ...
            while True:
                ...
                print()
                get_input = input(
                    "Enter the number of your selection (1-4): ").strip().lower()
    ...
    def search_by_date(self):
        ...
        while True:
            print()
            get_input = input("Enter the number for the date you wish to see (1-{}): ".format(
                len(self.task_list.date_list()))).strip().lower()
            try:
    ...
    def search_by_duration(self):
        ...
        while True:
            print()
            get_input = input("Enter the number for the duration you wish to see (1-{}): ".format(
                len(self.task_list.durations()))).strip().lower()
            try:
                input_as_zero_based_int = int(get_input) - 1
            except ValueError:
                print("That isn't a valid option. Try again.")
                ...
                if input_as_zero_based_int >= 0 and input_as_zero_based_int < len(
                    ...
                    print("\033c", end="")
                    request_minutes = int(self.task_list.durations()[
                                          input_as_zero_based_int])
    ...
    def search_by_text(self):
        ...
        if len(list_of_tasks) > 0:
            ...
            print()
            print(
                "The string '{}' is not in any of your task names or notes.".format(get_input))
            print()
