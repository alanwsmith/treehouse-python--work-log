...
class TaskListTest:
    ...
    def test_date_list(self):
        task_list = TaskList()
        self.assert_equal(
            True, task_list.read_from_file('tests/fixture-2.csv'))
        target_date_list = [
            "2016-01-03",
            "2016-02-07",
            "2016-11-12",
    ...
    def test_read_from_file(self):
        task_list = TaskList()
        self.assert_equal(
            True, task_list.read_from_file('tests/fixture-1.csv'))
    ...
    def test_read_from_file_that_does_not_exist(self):
        task_list = TaskList()
        self.assert_equal(True, task_list.read_from_file(
            'file-that-does-not-exist.csv'))
